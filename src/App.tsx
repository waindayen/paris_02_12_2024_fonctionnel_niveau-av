...
import UserMobileNavigation from './components/layout/UserMobileNavigation';
...
const MainLayout = () => {
  ...
  const showBetSlip = location.pathname === '/';
  
  return (
    <div className="min-h-screen bg-gray-50">
      <Header onToggleBetSlip={() => setIsBetSlipOpen(!isBetSlipOpen)} showBetSlip={showBetSlip} />
      <div className={`pt-16 pb-20 md:pb-0 ${showBetSlip ? 'md:pr-80' : ''}`}>
        <Outlet />
      </div>
      {showBetSlip && (
